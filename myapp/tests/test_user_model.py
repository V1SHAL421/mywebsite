...
class UserModelTestCase(TestCase):
    ...
    def test_can_be_30_characters_long(self):
        self.user.username = '@' + 'x' * 29
        self._assert_user_is_valid()
    
    def test_cannot_be_over_30_characters_long(self):
    ...
    def test_first_name_contains_no_more_than_30_characters(self):
    ...
    def test_last_name_contains_no_more_than_30_characters(self):
    ...
    def test_email_must_contain_a_symbol(self):
    ...
    def test_bio_may_contain_400_characters(self):
        self.user.bio = 'a'*400
        self._assert_user_is_valid()

    def test_bio_may_not_contain_over_400_characters(self):
        self.user.bio = 'a'*401
        self._assert_user_is_invalid()
